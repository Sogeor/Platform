...
i686-bootloader:
	make -C bootloader i686

i686-kernel:
	make -C bootloader i686

build/i686/i686.raw:
	mkisofs -V "BOOTLOADER" -o build/i686/i686.raw -b bootloader.bin -no-emul-boot "bootloader/build/i686/"
	dd if=bootloader/build/i686/bootloader.bin of=build/i686/i686.raw conv=notrunc
...
build/x86_64/x86_64.raw:
	mkisofs -V "BOOTLOADER" -o build/x86_64/x86_64.raw -b bootloader.bin -no-emul-boot "bootloader/build/i686/"
	dd if=bootloader/build/i686/bootloader.bin of=build/x86_64/x86_64.raw conv=notrunc
