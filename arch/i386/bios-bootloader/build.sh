...
nasm -I ../build/include -I ../../../../shared/soglib/include -f elf32 -o ../build/objects/$(dirname $1)/$(basename $1).o $1
' shell {} \;
find . -type f -name '*.c' -exec bash -c '
mkdir -p ../build/objects/$(dirname $1)
echo "[i386] [bios-bootloader] [compiling] ../build/objects/$(dirname $1)/$(basename $1).o"
i686-elf-gcc -I ../build/include -I ../../../../shared/soglib/include -std=gnu17 -Wall -O0 -ffreestanding -c -o ../build/objects/$(dirname $1)/$(basename $1).o $1
' shell {} \;
find . -type f -name '*.cpp' -exec bash -c '
mkdir -p ../build/objects/$(dirname $1)
echo "[i386] [bios-bootloader] [compiling] ../build/objects/$(dirname $1)/$(basename $1).o"
i686-elf-g++ -I ../build/include -I ../../../../shared/soglib/include -std=gnu++17 -Wall -O0 -ffreestanding -c -o ../build/objects/$(dirname $1)/$(basename $1).o $1
' shell {} \;
popd
