...
extern volatile uint32_t x16_real_dap_number_of_sectors;
extern volatile uint32_t x16_real_dap_buffer_offset;
extern volatile uint32_t x16_real_dap_buffer_segment;
